                ...
                <form action="{{ route('subscribe.post') }}" method="post">
                    ...
                    <div class="textAndIcon ">
                        <svg version="1.1" id="OBJECTS" xmlns="http://www.w3.org/2000/svg"
                            ...
                            viewBox="0 0 105 108" style="enable-background:new 0 0 105 108;"
                            xml:space="preserve">
                            <style type="text/css">
                                .iconst0 {
                                    fill: #fff;
                            ...
                            <g>
                                <g>
                                    <path class="iconst0"
                                        d="M5.8,39.9l0.5,0.4c7.5,5,16.3,7.7,25.3,7.7l0,0c8.7,0,17.3-2.5,24.6-7.3l0,0c1.1-0.7,2.3,0.6,1.6,1.7
                                    ...
                                    <path class="iconst0"
                                        d="M99.8,52.9l-0.4,0.3c-6,4-13,6.2-20.2,6.2l0,0c-7,0-13.8-2-19.6-5.8l0,0c-0.9-0.6-1.9,0.5-1.3,1.3L72.5,74
                                    ...
                                    <path class="iconst0"
                                        d="M39.4,76.1l0.3,0.2c4.5,3.1,9.9,4.7,15.3,4.7l0,0c5.3,0,10.5-1.5,14.9-4.4l0,0c0.7-0.4,1.4,0.4,1,1L60.2,92.2
                                    ...
                                    <path class="iconst0"
                                        d="M54.4,3.6c-20.2,0-37.2,13.9-41.8,32.7C19.2,21.1,34.4,10.5,52,10.5c10.2,0,19.5,3.5,26.9,9.4
                                        c1.5,1.2,3.8,0.9,4.9-0.8l0,0c1-1.4,0.7-3.3-0.6-4.4C75.6,7.8,65.5,3.6,54.4,3.6z" />
                                    <path class="iconst0"
                                        d="M90.2,18.6l1.7,3.4c0.1,0.2,0.3,0.3,0.5,0.4l3.8,0.6c0.5,0.1,0.8,0.7,0.4,1.1l-2.7,2.7
