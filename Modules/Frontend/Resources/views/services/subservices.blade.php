...
<head>
    ...
    <title>{{ site_name() }} | {{ __('Sub Services') }}</title>
    <!-- favicon -->
                    ...
                    <div class="row">
                        ...
                        @forelse ($subservices as $service)
                            ...
                            <div class="col-md-6 col-xl-4">
                                <a href="{{ route('service.show', $service->id) }}" class="my_Card" data-aos="fade">
                                    <!-- top card  -->
                                    <div class="top_card">
                                        <img src="{{ $service->getFirstMediaUrl('images') }}" alt="">
                                    </div>
                                    <!-- btn card  -->
                                    <div class="app_text" dir-right="true"
                                        ...
                                        <h3 class="title_card ml-0">{{ $service->name }}</h3>
                                        <p>
                                            {!! strip_tags( Str::limit($service->description, 100, '...') ) !!}
                                        </p>
                                    </div>
                                </a>
                            </div>
