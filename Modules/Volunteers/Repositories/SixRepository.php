...
class SixRepository implements CrudRepository
{
    /**
    ...
    public function all()
    {
        return QuestionSix::filter($this->filter)->paginate(request('perPage'));
    }
    ...
    public function create(array $data)
    {
        ...
        $question = QuestionSix::create($data);
     ...
     *
     * @param mixed $model
     * @return \Modules\Volunteers\Entities\QuestionSix
     */
    public function find($model)
    {
        if ($model instanceof QuestionSix) {
            return $model;
        }

        return QuestionSix::findOrFail($model);
    }
