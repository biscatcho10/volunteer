...
<div class="row">
    ...
    <div class="col-6">
        ...
        <select name="how_know_id[]" class="form-control selectpicker" data-live-search="true" data-actions-box="true" multiple>
...
{{--
        ...
        <select name="field_id[]" id="field" class="form-control selectpicker" data-live-search="true" data-actions-box="true" multiple>
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <select name="volunteer_category[]" id="v_category" class="form-control selectpicker" data-live-search="true" data-actions-box="true" multiple>
